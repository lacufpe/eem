...
Desculpem a confusão com a sequência dos vídeos. A sequência é:
1 - Espira sob campo
2 - Principio de funcionamento de motor CC
cípio de funcionamento
4 - Aspectos construtivos de motor CC, parte 2
5 - Motor CC 3 - Enrolamento de armadura
